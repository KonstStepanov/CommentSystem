...
class MessageService {
    ...
    updateCommentCount() {
        var _a, _b;
        const commentsNumberElement = document.getElementById("commentsNumber");
        const totalComments = (parseInt((_b = (_a = commentsNumberElement === null || commentsNumberElement === void 0 ? void 0 : commentsNumberElement.textContent) === null || _a === void 0 ? void 0 : _a.replace(/[()]/g, "")) !== null && _b !== void 0 ? _b : "0", 10) + 1) || 0;
        if (commentsNumberElement) {
    ...
    filterFavorites() {
        ...
        replyContainers.forEach((container) => {
            ...
            if (favoriteElement) {
                const isParentFavorite = ((_a = favoriteElement.textContent) === null || _a === void 0 ? void 0 : _a.trim()) === "В избранном";
                const hasFavoriteReplies = Array.from(container.querySelectorAll(".reply-container__reply")).some((reply) => {
                    var _a;
                    const replyFavorite = reply.querySelector(".navigation-favorite");
                    return ((_a = replyFavorite === null || replyFavorite === void 0 ? void 0 : replyFavorite.textContent) === null || _a === void 0 ? void 0 : _a.trim()) === "В избранном";
                });
                container.style.display = isParentFavorite || hasFavoriteReplies ? "" : "none";
            }
        });
        replies.forEach((reply) => {
            ...
            const replyFavorite = reply.querySelector(".navigation-favorite");
            if (replyFavorite) {
                const isFavorite = ((_a = replyFavorite.textContent) === null || _a === void 0 ? void 0 : _a.trim()) === "В избранном";
                reply.style.display = isFavorite ? "" : "none";
            }
        });
    }
    showAllMessages() {
    ...
    updateMessageRating(target, value) {
        ...
        const id = parseInt((_a = parentContainer.dataset.id) !== null && _a !== void 0 ? _a : "0", 10);
    ...
    sortMessagesByRating(ascending = false) {
        ...
        this.messages.forEach(msg => msg.replies.sort((a, b) => ascending ? a.rating - b.rating : b.rating - a.rating));
...
MessageService.MESSAGES_KEY = "savedMessages";
MessageService.TOTAL_COMMENTS_KEY = "totalComments";
MessageService.FAVORITES_KEY = "favorites";
...
function createNewMessage(text, avatarElement, nameElement, currentDateTime) {
    var _a;
    return new Message(Date.now(), avatarElement.src, (_a = nameElement.textContent) !== null && _a !== void 0 ? _a : "Anonymous", text, currentDateTime);
}
function handleReplyMode(newMessage) {
    if (messageService.replyToMessageId === null) {
        console.error("ReplyToMessageId is null, cannot proceed.");
        return;
    }
    const parentContainer = document.querySelector(`.reply-container[data-id="${messageService.replyToMessageId}"]`);
    if (!parentContainer) {
...
document.addEventListener("click", (event) => {
    ...
    if (target.classList.contains("navigation-reply")) {
        const parentContainer = target.closest(".reply-container");
        const parentId = parseInt((_a = parentContainer === null || parentContainer === void 0 ? void 0 : parentContainer.dataset.id) !== null && _a !== void 0 ? _a : "0", 10);
        if (parentId) {
    ...
    if (target.classList.contains("navigation-favorite")) {
        ...
        if (target.closest(".reply-container__reply")) {
            parentContainer = target.closest(".reply-container__reply");
        }
        else {
            parentContainer = target.closest(".reply-container");
        }
        if (!parentContainer) {
            console.error("Parent container not found for favorite action.");
            return;
        }
        const id = parseInt((_b = parentContainer.dataset.id) !== null && _b !== void 0 ? _b : "0", 10);
        if (isNaN(id) || id <= 0) {
...
function createReplyElement(reply, senderName) {
