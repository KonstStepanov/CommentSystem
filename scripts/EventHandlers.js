...
export class EventHandlers {
    initMessageService(/* NOSONAR */ messageService, textAreaElement, sendButtonElement, errorMessageElement, messageSizeElement, containerElement, filterButton, sortArrow, byDateOption, byMarksOption, byAnswersOption, DEFAULT_TEXT) {
